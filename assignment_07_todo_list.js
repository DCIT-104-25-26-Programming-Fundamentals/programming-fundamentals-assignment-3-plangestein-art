...
/**
 * Displays all tasks currently in the tasks array.
 * 
 * @param {string[]} tasks - The array of tasks.
 */
...
/**
 * Deletes a task from the tasks array based on user input.
 * 
 * @param {string[]} tasks - The array of tasks.
 */
...
/**
 * Main function to run the To-Do List interactive menu program.
 */
function main() {
    const tasks = [];
    let running = true;
