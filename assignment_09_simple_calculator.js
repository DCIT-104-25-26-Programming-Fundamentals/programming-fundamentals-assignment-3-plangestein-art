...
/**
 * Computes the modulus of the first number by the second.
 * 
 * @param {number} a - First number.
 * @param {number} b - Second number.
 * @returns {number|string} - The remainder or an error message if dividing by zero.
 */
 ...
 * @param {number} b - Exponent number.
...
/**
 * Main function to run the Simple Calculator interactive program.
 */
function main() {
    let running = true;
